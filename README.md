...
#### NetworkClient.java (수정) - 설정 정보를 사용하도록 변경
...
#### BeanLifeCycleTest.java (수정) - 설정 정보에 초기화 소멸 메서드 지정
...
#### NetworkClient.java (수정) - @PostConstruct, @PreDestroy 추가
...
#### BeanLifeCycleTest.java (수정) - @Bean 속성 제거
